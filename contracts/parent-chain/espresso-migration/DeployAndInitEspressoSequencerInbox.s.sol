...
contract DeployAndInitEspressoSequencerInbox is Script {
    function run() external {
        ...
        address[] batchPosters = vm.envAddress("BATCH_POSTER_ADDRS", ",");
        ...
        SequencerInbox sequencerInbox = new SequencerInbox(maxDataSize, IReader4844, isUsingFeeToken);
        MaxTimeVariation maxTimeVariation = MaxTimeVariation({
