...
contract ExecuteNitroContracts2Point1Point3UpgradeScript is Script {
    function run() public {
        ...
        CelestiaNitroContracts2Point1Point3UpgradeAction upgradeAction =
            CelestiaNitroContracts2Point1Point3UpgradeAction(vm.envAddress("UPGRADE_ACTION_ADDRESS"));
        ...
        bytes memory upgradeCalldata = abi.encodeCall(
            CelestiaNitroContracts2Point1Point3UpgradeAction.perform, (rollup, address(inbox), proxyAdmin)
        );
