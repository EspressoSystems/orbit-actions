...
import {
    CelestiaNitroContracts2Point1Point0UpgradeAction,
    IOneStepProofEntry
} from "../../../../contracts/parent-chain/contract-upgrades/CelestiaNitroContracts2Point1Point0UpgradeAction.sol";
 ...
 */
contract DeployCelestiaNitroContracts2Point1Point0UpgradeActionScript is DeploymentHelpersScript {
    ...
    function run() public {
        ...
        address newOsp;
        {
            ...
            if (chainId == 1) {
                ospHostIo =
                    deployBytecodeFromJSON("/celestia-2.1.0/mainnet/OneStepProverHostIo.sol/OneStepProverHostIo.json");
            } else if (chainId == 11155111) {
                // sepolia
                ospHostIo =
                    deployBytecodeFromJSON("/celestia-2.1.0/sepolia/OneStepProverHostIo.sol/OneStepProverHostIo.json");
                ...
                // base
                ospHostIo =
                    deployBytecodeFromJSON("/celestia-2.1.0/base/OneStepProverHostIo.sol/OneStepProverHostIo.json");
