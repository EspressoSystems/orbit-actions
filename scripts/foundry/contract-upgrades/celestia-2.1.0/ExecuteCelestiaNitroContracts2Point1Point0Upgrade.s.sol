...
contract ExecuteCelestiaNitroContracts2Point1Point0UpgradeScript is Script {
    function run() public {
        ...
        CelestiaNitroContracts2Point1Point0UpgradeAction upgradeAction =
            CelestiaNitroContracts2Point1Point0UpgradeAction(vm.envAddress("UPGRADE_ACTION_ADDRESS"));
        ...
        bytes memory upgradeCalldata =
            abi.encodeCall(CelestiaNitroContracts2Point1Point0UpgradeAction.perform, (rollup, proxyAdmin));
