...
import {
    CelestiaNitroContracts1Point2Point1UpgradeAction,
    ProxyAdmin
} from "../../../../contracts/parent-chain/contract-upgrades/CelestiaNitroContracts1Point2Point1UpgradeAction.sol";
...
contract ExecuteNitroContracts1Point2Point1UpgradeScript is Script {
    function run() public {
        ...
        CelestiaNitroContracts1Point2Point1UpgradeAction upgradeAction =
            CelestiaNitroContracts1Point2Point1UpgradeAction(vm.envAddress("UPGRADE_ACTION_ADDRESS"));
        ...
        bytes memory upgradeCalldata =
            abi.encodeCall(CelestiaNitroContracts1Point2Point1UpgradeAction.perform, (rollup, proxyAdmin));
