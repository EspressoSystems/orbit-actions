 ...
 */
contract ExecuteEspressoNitroContracts2Point1Point3UpgradeScript is Script {
    function run() public {
        EspressoNitroContracts2Point1Point3UpgradeAction upgradeAction =
            EspressoNitroContracts2Point1Point3UpgradeAction(vm.envAddress("UPGRADE_ACTION_ADDRESS"));
        ...
        bytes memory upgradeCalldata =
            abi.encodeCall(EspressoNitroContracts2Point1Point3UpgradeAction.perform, (inbox, proxyAdmin));
