 ...
 */
contract DeployEspressoNitroContracts2Point1Point3UpgradeActionScript is DeploymentHelpersScript {
    function run() public {
        ...
        new EspressoNitroContracts2Point1Point3UpgradeAction(
            newEthInboxImpl, newERC20InboxImpl, newEthSeqInboxImpl, newErc20SeqInboxImpl, espressoTEEVerifier
        );
